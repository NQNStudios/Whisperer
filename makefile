...
CFLAGS=-g -Wall -Wextra -std=c++11 -MMD `sdl2-config --cflags` -I../ASCIILib/ASCIILib
...
LDLIBS=`sdl2-config --libs` -lSDL2_ttf -lSDL2_mixer -lSDL2_image -L../ASCIILib/bin -lASCIILib
